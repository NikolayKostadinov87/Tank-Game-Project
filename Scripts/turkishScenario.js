function turkishScenario() {
    ...
    var FirstAlphaSniperEnemy = particle.create(1850 , 620 , 0 , 0);
    var SecondAlphaSniperEnemy = particle.create(1720 , 650 , 0 , 0);
    var ThirdAlphaSniperEnemy = particle.create(1650 , 750 , 0 , 0);
    var FourthAlphaSniperEnemy = particle.create(1500 , 935 , 0 , 0);
    var FifthAlphaSniperEnemy = particle.create(1570 , 850 , 0 , 0);
    //---------------TANK PROPERTIES---------------
    ...
    let bullets = [] , enemyBullets = [] , enemies = [] , SuicideEnemyArr = [] , suicideEnemyBullets = [];
    //-----GAME OVER SOUND-----
    ...
    var isDeadFirstEnemy = false ,isDeadSecondEnemy = false ,isDeadThirdEnemy = false ,isDeadFourthEnemy = false ,isDeadFifthEnemy = false ;
    ...
    var turkish_flag = new Image();
    turkish_flag.src = "EnemiesSkins/ottoman_empire_flag_circle.png";
    var background = new Image();
    background.src = "Background/secondCampaignBackgroundCapital.png";
    //AUDIO
    ...
    class SuicideEnemies{
        ...
        Draw(){
            context.beginPath();
            context.arc(this.x , this.y , this.radius , 0 , Math.PI * 2 , false);
            context.drawImage(turkish_flag , this.x - this.radius , this.y - this.radius , 50 , 50);
            context.stroke();
        }
    } 
